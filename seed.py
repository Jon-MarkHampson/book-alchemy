...
def seed_db_command():
    ...
    if Author.query.count() == 0:
        authors_data = [
            ...
            {'name': 'Stephen King', 'birth_date': '1947-9-21',
                'death_date': None, 'bio': None},
            {'name': 'Dan Brown', 'birth_date': '1964-6-22',
                'death_date': None, 'bio': None},
            {'name': 'John Grisham', 'birth_date': '1955-2-8',
                'death_date': None, 'bio': None},
            {'name': 'George R.R. Martin', 'birth_date': '1948-9-20',
                'death_date': None, 'bio': None},
            {'name': 'Suzanne Collins', 'birth_date': '1962-8-10',
                'death_date': None, 'bio': None},
            {'name': 'E.L. James', 'birth_date': '1963-3-7',
                'death_date': None, 'bio': None},
            {'name': 'Paula Hawkins', 'birth_date': '1972-8-26',
                'death_date': None, 'bio': None},
            {'name': 'Gillian Flynn', 'birth_date': '1971-2-24',
                'death_date': None, 'bio': None},
            {'name': 'Stieg Larsson', 'birth_date': '1954-8-15',
                'death_date': '2004-11-9', 'bio': None},
            {'name': 'Khaled Hosseini', 'birth_date': '1965-3-4',
                'death_date': None, 'bio': None},
            {'name': 'Yann Martel', 'birth_date': '1963-6-25',
                'death_date': None, 'bio': None},
            {'name': 'Markus Zusak', 'birth_date': '1975-6-23',
                'death_date': None, 'bio': None},
            {'name': 'Audrey Niffenegger', 'birth_date': '1963-6-13',
                'death_date': None, 'bio': None},
            {'name': 'Alice Sebold', 'birth_date': '1963-9-6',
                'death_date': None, 'bio': None},
            {'name': 'Kathryn Stockett', 'birth_date': '1969-1-1',
                'death_date': None, 'bio': None},  # Approx birth year
            {'name': 'Andy Weir', 'birth_date': '1972-6-16',
                'death_date': None, 'bio': None},
            {'name': 'Ernest Cline', 'birth_date': '1972-3-29',
                'death_date': None, 'bio': None},
            {'name': 'Celeste Ng', 'birth_date': '1980-7-30',
                'death_date': None, 'bio': None},
            {'name': 'Delia Owens', 'birth_date': '1949-4-4',
                'death_date': None, 'bio': None},
            {'name': 'Michelle Obama', 'birth_date': '1964-1-17',
                'death_date': None, 'bio': None},
            {'name': 'Tara Westover', 'birth_date': '1986-9-27',
                'death_date': None, 'bio': None},
            {'name': 'James Clear', 'birth_date': None,
                'death_date': None, 'bio': None},
            {'name': 'Mark Manson', 'birth_date': '1984-3-9',
                'death_date': None, 'bio': None},
            {'name': 'Yuval Noah Harari', 'birth_date': '1976-2-24',
                'death_date': None, 'bio': None},
            {'name': 'Malcolm Gladwell', 'birth_date': '1963-9-3',
                'death_date': None, 'bio': None},
            {'name': 'Brené Brown', 'birth_date': '1965-11-18',
                'death_date': None, 'bio': None},
            {'name': 'Elizabeth Gilbert', 'birth_date': '1969-7-18',
                'death_date': None, 'bio': None},
            {'name': 'Cheryl Strayed', 'birth_date': '1968-9-17',
                'death_date': None, 'bio': None},
            {'name': 'Bill Bryson', 'birth_date': '1951-12-8',
                'death_date': None, 'bio': None},
            {'name': 'Michael Lewis', 'birth_date': '1960-10-15',
                'death_date': None, 'bio': None},
            {'name': 'Walter Isaacson', 'birth_date': '1952-5-20',
                'death_date': None, 'bio': None},
            {'name': 'Erik Larson', 'birth_date': '1954-1-3',
                'death_date': None, 'bio': None},
            {'name': 'David McCullough', 'birth_date': '1933-7-7',
                'death_date': '2022-8-7', 'bio': None},
            {'name': 'Ron Chernow', 'birth_date': '1949-3-3',
                'death_date': None, 'bio': None},
            {'name': 'Jon Krakauer', 'birth_date': '1954-4-12',
                'death_date': None, 'bio': None},
            {'name': 'Rebecca Skloot', 'birth_date': '1972-9-19',
                'death_date': None, 'bio': None},
            {'name': 'Mary Roach', 'birth_date': '1959-3-20',
                'death_date': None, 'bio': None},
            {'name': 'Susan Cain', 'birth_date': '1968-5-1',
                'death_date': None, 'bio': None},
            {'name': 'Daniel Kahneman', 'birth_date': '1934-3-5',
                'death_date': '2024-3-27', 'bio': None},
            {'name': 'Stephen Hawking', 'birth_date': '1942-1-8',
                'death_date': '2018-3-14', 'bio': None},
            {'name': 'Carl Sagan', 'birth_date': '1934-11-9',
                'death_date': '1996-12-20', 'bio': None},
            {'name': 'Richard Dawkins', 'birth_date': '1941-3-26',
                'death_date': None, 'bio': None},
            {'name': 'Neil Gaiman', 'birth_date': '1960-11-10',
                'death_date': None, 'bio': None},
            {'name': 'Margaret Atwood', 'birth_date': '1939-11-18',
                'death_date': None, 'bio': None},
            {'name': 'Kazuo Ishiguro', 'birth_date': '1954-11-8',
                'death_date': None, 'bio': None},
            {'name': 'Haruki Murakami', 'birth_date': '1949-1-12',
                'death_date': None, 'bio': None},
            {'name': 'Cormac McCarthy', 'birth_date': '1933-7-20',
                'death_date': '2023-6-13', 'bio': None},
            {'name': 'Philip Pullman', 'birth_date': '1946-10-19',
                'death_date': None, 'bio': None},
            {'name': 'Ken Follett', 'birth_date': '1949-6-5',
                'death_date': None, 'bio': None},
            {'name': 'Diana Gabaldon', 'birth_date': '1952-1-11',
                'death_date': None, 'bio': None},
            {'name': 'Nicholas Sparks', 'birth_date': '1965-12-31',
                'death_date': None, 'bio': None},
            {'name': 'Jodi Picoult', 'birth_date': '1966-5-19',
                'death_date': None, 'bio': None},
            {'name': 'Stephenie Meyer', 'birth_date': '1973-12-24',
                'death_date': None, 'bio': None},
            {'name': 'Veronica Roth', 'birth_date': '1988-8-19',
                'death_date': None, 'bio': None},
            {'name': 'Rick Riordan', 'birth_date': '1964-6-5',
                'death_date': None, 'bio': None},
            {'name': 'Jeff Kinney', 'birth_date': '1971-2-19',
                'death_date': None, 'bio': None},
            {'name': 'Dav Pilkey', 'birth_date': '1966-3-4',
                'death_date': None, 'bio': None},
            {'name': 'Dr. Seuss', 'birth_date': '1904-3-2',
                'death_date': '1991-9-24', 'bio': None},
            {'name': 'Roald Dahl', 'birth_date': '1916-9-13',
                'death_date': '1990-11-23', 'bio': None},
            {'name': 'Shel Silverstein', 'birth_date': '1930-9-25',
                'death_date': '1999-5-10', 'bio': None},
            {'name': 'Eric Carle', 'birth_date': '1929-6-25',
                'death_date': '2021-5-23', 'bio': None},
            {'name': 'J.R.R. Tolkien', 'birth_date': '1892-1-3',
                'death_date': '1973-9-2', 'bio': None},
            {'name': 'George Orwell', 'birth_date': '1903-6-25',
                'death_date': '1950-1-21', 'bio': None},
            {'name': 'Agatha Christie', 'birth_date': '1890-9-15',
                'death_date': '1976-1-12', 'bio': None},
            {'name': 'Paulo Coelho', 'birth_date': '1947-8-24',
                'death_date': None, 'bio': None},
            {'name': 'Gabriel Garcia Marquez', 'birth_date': '1927-3-6',
                'death_date': '2014-4-17', 'bio': None},
            {'name': 'Umberto Eco', 'birth_date': '1932-1-5',
                'death_date': '2016-2-19', 'bio': None},
            {'name': 'Mario Puzo', 'birth_date': '1920-10-15',
                'death_date': '1999-7-2', 'bio': None},
            {'name': 'Arthur Golden', 'birth_date': '1956-12-6',
                'death_date': None, 'bio': None},
            {'name': 'Frank McCourt', 'birth_date': '1930-8-19',
                'death_date': '2009-7-19', 'bio': None},
            {'name': 'Mitch Albom', 'birth_date': '1958-5-23',
                'death_date': None, 'bio': None},
            {'name': 'John Green', 'birth_date': '1977-8-24',
                'death_date': None, 'bio': None},
            {'name': 'R.J. Palacio', 'birth_date': '1963-7-13',
                'death_date': None, 'bio': None},
            {'name': 'Angie Thomas', 'birth_date': '1988-9-20',
                'death_date': None, 'bio': None},
            {'name': 'Andy Griffiths', 'birth_date': '1961-9-3',
                'death_date': None, 'bio': None},
            {'name': 'Terry Denton', 'birth_date': '1950-7-26',
                'death_date': None, 'bio': None},
            ...
            if data['name'] not in added_author_names:
                try:
                    ...
                    death_date_obj = datetime.strptime(
                        data['death_date'], '%Y-%m-%d').date() if data['death_date'] else None
                    author = Author(
    ...
    if Book.query.count() == 0:
        books_data = [
            ...
            {'isbn': '9780394800011', 'title': 'Green Eggs and Ham',
                'publication_date': '1960-8-12', 'author_name': 'Dr. Seuss'},
            # Roald Dahl (Classic, still high-selling)
            {'isbn': '9780142410318', 'title': 'Charlie and the Chocolate Factory',
                'publication_date': '1964-1-17', 'author_name': 'Roald Dahl'},
            # Shel Silverstein (Classic, still high-selling)
            {'isbn': '9780060256654', 'title': 'The Giving Tree',
                'publication_date': '1964-10-7', 'author_name': 'Shel Silverstein'},
            # Eric Carle (Classic, still high-selling)
            {'isbn': '9780399226908', 'title': 'The Very Hungry Caterpillar',
                'publication_date': '1969-6-3', 'author_name': 'Eric Carle'},
            # Paulo Coelho
            {'isbn': '9780061122416', 'title': 'The Alchemist',
                'publication_date': '1988-1-1', 'author_name': 'Paulo Coelho'},
            # Gabriel Garcia Marquez
            {'isbn': '9780061120084', 'title': 'One Hundred Years of Solitude',
                'publication_date': '1967-5-30', 'author_name': 'Gabriel Garcia Marquez'},
            # Umberto Eco
            {'isbn': '9780151446476', 'title': 'The Name of the Rose',
                'publication_date': '1980-1-1', 'author_name': 'Umberto Eco'},
            # Mario Puzo
            {'isbn': '9780451205766', 'title': 'The Godfather',
                'publication_date': '1969-3-10', 'author_name': 'Mario Puzo'},
            # Arthur Golden
            {'isbn': '9780679781582', 'title': 'Memoirs of a Geisha',
                'publication_date': '1997-9-23', 'author_name': 'Arthur Golden'},
            # Frank McCourt
            {'isbn': '9780684842670', 'title': "Angela's Ashes",
                'publication_date': '1996-9-5', 'author_name': 'Frank McCourt'},
            # Mitch Albom
            {'isbn': '9780751529814', 'title': 'Tuesdays with Morrie',
                'publication_date': '1997-8-18', 'author_name': 'Mitch Albom'},
            # John Green
            {'isbn': '9780525478812', 'title': 'The Fault in Our Stars',
                'publication_date': '2012-1-10', 'author_name': 'John Green'},
            # R.J. Palacio
            {'isbn': '9780375869020', 'title': 'Wonder',
                'publication_date': '2012-2-14', 'author_name': 'R.J. Palacio'},
            # Angie Thomas
            {'isbn': '9780062498533', 'title': 'The Hate U Give',
                'publication_date': '2017-2-28', 'author_name': 'Angie Thomas'},
            # Andy Griffiths & Terry Denton (Example of collaboration)
            {'isbn': '9781250026903', 'title': 'The 13-Story Treehouse', 'publication_date': '2013-4-1',
                'author_name': 'Andy Griffiths'},  # Assigning to primary author
        ]

        # Fetch authors from DB to link by ID
        authors_in_db = {
            author.name: author.id for author in Author.query.all()}
        books_to_add = []
